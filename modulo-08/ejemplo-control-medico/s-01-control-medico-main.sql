...
--usuario del ejemplo 
define p_usuario=rodrigo_med

--password de la practica
define p_usr_pwd=rodrigo

--nombre de la pdb donde se crearán las tablas
define p_pdb1=rgpdip02

--sys
define p_sys_pwd=system2
...
accept p_pdb1 default '&&p_pdb1' prompt '3. Nombre de la base a emplear. [&&p_pdb1]: '
