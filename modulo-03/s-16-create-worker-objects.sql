--Este script hara uso de una variable de sustitucion p_user definida en 
--el script que lo invoca: s-15-create-workers.sql

prompt Conectando como usuario &p_user
connect &p_user/&p_user

prompt Creando objetos para simular carga de trabajo 
--tabla de datos
...
--tabla de conteos por registros
...
--tabla de conteos (simulacion de analisis de datos)
...
--procedimiento  empleado para analizar resultado
